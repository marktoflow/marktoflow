...
import { ClaudeAcpInitializer } from './adapters/claude-acp.js';
import { OpenCodeInitializer } from './adapters/opencode.js';
import { GitHubCopilotInitializer } from './adapters/github-copilot.js';
import { GitHubCopilotAcpInitializer } from './adapters/github-copilot-acp.js';
import { CodexInitializer } from './adapters/codex.js';
import { CodexAcpInitializer } from './adapters/codex-acp.js';
import { GeminiCliInitializer } from './adapters/gemini-cli.js';
import { GeminiCliAcpInitializer } from './adapters/gemini-cli-acp.js';
...
export function registerIntegrations(registry: SDKRegistry) {
  ...
  registry.registerInitializer('claude-code-acp', ClaudeAcpInitializer);
  ...
  registry.registerInitializer('copilot-acp', GitHubCopilotAcpInitializer);
  registry.registerInitializer('codex', CodexInitializer);
  registry.registerInitializer('@openai/codex-sdk', CodexInitializer);
  registry.registerInitializer('codex-acp', CodexAcpInitializer);
  ...
  registry.registerInitializer('@google/gemini-cli', GeminiCliInitializer);
  registry.registerInitializer('gemini-acp', GeminiCliAcpInitializer);
...
export * from './adapters/acp-agent.js';
